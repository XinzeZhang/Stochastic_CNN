...
with tf.Session() as sess:
    ...
    with open("./Argu_Result_npz/outputlog.txt", "a+") as f:
...
np.savez("./Argu_Result_npz/acc"+str(int(microtrain_steps/display_step))+"_"+ numberOfnet +".npz", test_acc_array, train_acc_array)
np.savez("./Argu_Result_npz/loss"+str(int(microtrain_steps/display_step))+"_"+ numberOfnet +".npz", test_loss_array, train_loss_array)
np.savez("./Argu_Result_npz/pred"+str(int(microtrain_steps/display_step))+"_"+ numberOfnet +".npz", prediction_array)
np.savez("./Argu_Result_npz/micro_pred"+str(int(microtrain_steps/display_step))+"_"+ numberOfnet +".npz", micro_prediction_array)
