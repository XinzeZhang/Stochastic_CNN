...
def plot_micro(type=0):
    ...
    K_color={"0":"C0","1":"C1","5":"C2","10":"C3","15":"C4","20":"C5","25":"C6","30":"C7","35":"C8","40":"C9"}
    ...
    plt.savefig('./DCDF_'+indicator+"_5.png")

def Acc_Plot(indicator,loc,micro_epochs,color):
    # test1,train1 = load_data("./Result_npz/"+kernel_num+"/"+indicator+str(micro_epochs)+".npz")
    test1,train1 = load_data("./C32_C64_F1024_F10/Argu_Result_npz_lastTwo/acc"+str(micro_epochs)+"_5.npz")
    size = np.size(test1)
