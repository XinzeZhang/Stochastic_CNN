...
parser.add_argument('--k_allTrain_epochs', type=int, default=100, metavar='N',
                    help='number of epochs to train (default: 100)')
parser.add_argument('--microTrain_epochs', type=int, default=200, metavar='N',
                    help='number of epochs to train (default: 200)')
# ------------------------------------------------------------------------------
parser.add_argument('--SGD_lr', type=float, default=0.0001, metavar='LR',
                    help='SGD learning rate (default: 0.01)')
parser.add_argument('--momentum', type=float, default=0.5, metavar='M',
                    help='SGD momentum (default: 0.5)')
parser.add_argument('--aT_Adam_lr', type=float, default=0.001, metavar='LR',
                    help='aT_Adam learning rate (default: 0.001)')
parser.add_argument('--mT_Adam_lr', type=float, default=0.0001, metavar='LR',
                    help='mT_Adam learning rate (default: 0.0001)')                    
# ------------------------------------------------------------------------------
